...
urlpatterns = [
    ...
    path('api/', include('service.urls')),  # Include the app's URLs
    path('api/', include('gas.urls')),  # Include the app's URLs
    path('api/', include('address.urls')),  # Include the app's URLs
